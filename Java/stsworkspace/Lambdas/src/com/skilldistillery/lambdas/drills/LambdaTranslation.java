...
public class LambdaTranslation {
	...
	public static void main(String[] args) {
		...
		/*
		 * public interface IntegerChecker { boolean test(Integer i); }
		 */
		...
		// 4. Print the results of isDivBy3Lambda.test(376) and
		// isDivBy3Lambda.test(144);
		System.out.println(isDivBy3Lambda.test(376));
		System.out.println(isDivBy3Lambda.test(144));
	}
}
